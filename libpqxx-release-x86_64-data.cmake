...
if(DEFINED libpqxx_FIND_DEPENDENCY_NAMES)
  list(APPEND libpqxx_FIND_DEPENDENCY_NAMES PostgreSQL)
  list(REMOVE_DUPLICATES libpqxx_FIND_DEPENDENCY_NAMES)
else()
  set(libpqxx_FIND_DEPENDENCY_NAMES PostgreSQL)
endif()
set(PostgreSQL_FIND_MODE "NO_MODULE")

########### VARIABLES #######################################################################
#############################################################################################
set(libpqxx_PACKAGE_FOLDER_RELEASE "C:/Users/saioa/.conan2/p/libpqc6090e8e4add9/p")
...
set(libpqxx_IS_HOST_WINDOWS_RELEASE 1)
set(libpqxx_LIBS_RELEASE pqxx)
set(libpqxx_SYSTEM_LIBS_RELEASE wsock32 ws2_32)
...
set(libpqxx_libpqxx_pqxx_IS_HOST_WINDOWS_RELEASE 1)
...
set(libpqxx_libpqxx_pqxx_SYSTEM_LIBS_RELEASE wsock32 ws2_32)
